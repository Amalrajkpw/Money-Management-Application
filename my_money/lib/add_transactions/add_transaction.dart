...
class _addTransactionScreenState extends State<addTransactionScreen> {
  ...
  String? categoryID;
  dynamic _descriptionTextController = TextEditingController();
  dynamic _amountTextController = TextEditingController();
  ...
  Future<void> validationOfAddTransactions() async {
    ...
    if (_amountParced == null ||
      ...
      final _transactionsSample = TransactionModel(
      ...
      TransactionsDB.instance.addTransaction(_transactionsSample);
